...
opts_chunk$set(out.width='0.48\\textwidth', fig.align='default', fig.height=3, fig.width=4, tidy=FALSE)
@    
...
<<priorPost, fig.cap="gamma priors sd parameters", fig.subcap=c("spatial", "indep"), echo=FALSE>>=
...
\verb!propSpatial = c(u=0.5, alpha=0.8)! means $pr(\phi < 0.5) = 0.8$, which is different from the specification of `pc.prec`
...
<<priorPostPc, fig.cap="PC priors variance parameters", fig.subcap=c("sd","prop spatial"), echo=FALSE>>=
