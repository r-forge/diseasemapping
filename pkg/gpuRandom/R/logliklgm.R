...
likfitGpu_0 <- function(Vbatch,
                        ...
                        Nglobal, localSize, localSizechol, NlocalCache){


  #get matern matrix
  gpuRandom::maternBatch(Vbatch, coordsGpu, paramsBatchperIter,  Nglobal, localSize)
  ...
  gpuRandom::crossprodBatch(temp2, ab, diagMat, invertD=TRUE, Nglobal, localSize, NlocalCache)
  ...
  if(form == 1 | form == 3){
    ...
    gemmBatch2backend(temp2, betas, temp00,
                      ...
                      c(Nglobal,localSize), #Nglobal  global 0 1 2, local 0 1 2
    ...
    gpuRandom::crossprodBatch(ssqBeta0, temp1, diagMat,  invertD=TRUE,  Nglobal, localSize, NlocalCache)
  ...
  gpuRandom:::cholBatchBackend(temp2, diagP, c(colbatch, p, colbatch, p), c(0, rowbatch, 0, p), rowbatch, Nglobal, localSizechol, NlocalCache)
  ...
  gpuRandom:::backsolveBatchBackend(temp3, temp2, temp2,
                                    ...
                                    rowbatch,diagIsOne=TRUE, Nglobal, localSize, NlocalCache)


  # ssqbetahat0 = temp3^T * P^(-1) * temp3,  four 1 by 1 matrices      3x3
  gpuRandom::crossprodBatch(ssqbetahat0, temp3, diagP, invertD=TRUE,  Nglobal, localSize, NlocalCache)
  ...
  gpuRandom:::backsolveBatchBackend(Qinverse, temp2, identity,
                                    ...
                                    c(colbatch, p, colbatch, p),
                                    c(0, p, 0, p),
                                    numbatchB=1L, diagIsOne=TRUE, Nglobal, localSize, NlocalCache)



  #// Q^(-T) P^(-1) Q^(-1) = QPQinverse
  gpuRandom::crossprodBatch(QPQinverse, Qinverse, diagP,  invertD=TRUE,  Nglobal, localSize, NlocalCache)
  ...
  #   gpuRandom:::matrix_vector_sumBackend(new_temp, logD_temp, form_temp, byrow = TRUE, Nglobal)
  #
  # }
  #
  if (form ==5 | form ==6){
  ...
  #   gpuRandom:::matrix_vector_sumBackend(new_temp, logD_temp, form_temp1, byrow = TRUE, Nglobal)
  ...
  #   gpuRandom:::matrix_vector_sumBackend(new_temp, logD_plusP, form_temp1, byrow = TRUE, Nglobal)
  #
