...
result<-gpuRandom::likfitGpu(spatialmodel,     #data,
                               ...
                               form = "ml",
                               NparamPerIter=50,  # how many sets of params to be evaluated in each loop
                               nBetahats =1,
                               minustwotimes=TRUE,
                               Nglobal=c(64,64,1),
                               Nlocal=c(16,16,1),
...
```{r likfit_givenBeta}
Betas <- t(expand.grid(intercept = seq(3,4,len=1), elevation = 5.4e-05))
