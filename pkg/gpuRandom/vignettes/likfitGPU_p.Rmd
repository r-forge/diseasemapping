...
otherparams = c(shape=1, variance=1.894534, anisoRatio = 1, anisoAngleRadians = 0)
...
result<-gpuRandom::likfitGpu(spatialmodel,     #data,
                               ...
                               form = "ml",
                               NparamPerIter=400,  # how many sets of params to be evaluated in each loop
                               nBetahats =1,
                               minustwotimes=TRUE,
                               Nglobal=c(64,64,2),
                               Nlocal=c(16,16,1),
...
lMatrix = matrix(mTwoLogLik[,3], length(newParamList[[1]]), length(newParamList[[2]]))
# 
