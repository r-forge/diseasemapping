...
newParamList = list(
  range=seq(30000, 80000 , len=16),
  nugget = seq(0,0.25,len=4)
) 
...
result<-gpuRandom::likfitGpu_2(spatialmodel,     #data,
            ...
            form = "ml",
            NparamPerIter=64,  # how many sets of params to be evaluated in each loop
            nBetahats =1,
            minustwotimes=TRUE,
            Nglobal=c(64,64,1),
            Nlocal=c(8,8,1),
...
# myParamsBatch = rbind(c(shape=1, range=34358, variance = 1.840997, nugget = 0.11, anisoRatio = 1, anisoAngleRadians = 0))
...
# paramsBatch  = vclMatrix(myParamsBatch, type=type)
newParamList = list(
