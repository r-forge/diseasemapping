...
myParamsBatch = myParamsBatch[rep(1,2),]
...
as.matrix(outputBatchF[(2-1)*ncol(outputBatchF) + 1:7,1:7])
...
gpuRandom::cholBatch(
  ...
  Nglobal = c(64L, 8L),#NglobalChol,
  Nlocal = c(16L, 4L),#NlocalChol,
