...
gpuC<-vclMatrix(0, nrow=18, ncol=3,type="double")   
gpuA<-vclMatrix(rbind(a,a,a,a,a,a),type="double")
gpuD<-vclMatrix(rbind(diag(D1),diag(D2),diag(D1),diag(D2),diag(D1),diag(D2)), nrow=6,ncol=nrow(D2),type='double')
