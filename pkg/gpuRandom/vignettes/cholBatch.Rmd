...
gpuRandom::cholBatch(outputChol, diagMat, numbatchD=nrow(myParamsBatch), Nglobal = c(32,1,1), Nlocal = c(8,1,1),NlocalCache = 3000)
dim(outputChol)
...
tempchol = as.matrix(outputChol)
chol4gpu = tempchol[a:b, ]
