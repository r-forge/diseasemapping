...
myParamsBatch = rbind(c(shape=2.25, range=0.1, variance = 1, nugget = 0, anisoRatio = 1, anisoAngleRadians = 0))
...
new=deepcopy(maternMatrix)
gpuRandom::cholBatch(new, diagMat, numbatchD=nrow(myParamsBatch),
                     Nglobal = c(8L, 8L, 8L),Nlocal=c(2,2,2),1)
...
chol4gpu = as.matrix(new[1:prod(Ngrid),])
