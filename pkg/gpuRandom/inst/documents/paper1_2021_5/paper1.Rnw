...
<<maternplot, echo=FALSE, eval=FALSE, cache=FALSE,dev='png', out.width = '0.45\\textwidth', fig.height=3, fig.width=6, fig.cap="Simulated Gaussian random fields", fig.subcap = names(simRaster)>>=
myCol = mapmisc::colourScale(simRaster, breaks=9, type='equal', dec=1)
