...
dt <- data.frame(
  ...
  var2 = c('Intel 2.5ghz', 0.403804, 0.0001251, 49.33,  327.27),
  var3 = c('AMD Radeon', 0.403507, 0.0001274,   2.15,    10.23),
...
myCol = mapmisc::colourScale(breaks=sort(unique(c(-7, -4, seq(-2, 2), 4, 7))), style='fixed', col='Spectral')
