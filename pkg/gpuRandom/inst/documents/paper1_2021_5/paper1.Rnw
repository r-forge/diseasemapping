...
Table \ref{tab:week} is a $7 \times 12$ table shows frequencies for congenital anomalies of the newborn by birth day of week in 2018 within the United States. The first 5 rows are displayed below.
...
knitr::kable(head(week),format="latex",align = c("rrrrrrrrrrrr"), caption = "Week\\label{tab:week}", booktabs=TRUE,linesep = "") %>%
  kable_styling(full_width = F, position = "center", latex_options = "HOLD_position")
@
