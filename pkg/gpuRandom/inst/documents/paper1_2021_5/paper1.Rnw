...
<<simStuff, eval=TRUE,tidy=TRUE>>=
sim_2 <-gpuRandom::runif(n=6, streams=myStreamsGpu1, Nglobal=c(1,nrow(myStreamsGpu1)), type = "double")
as.vector(sim_2)
@
...
<<simStuff, eval=TRUE,tidy=TRUE>>=
c(as.vector(sim_2), as.vector(gpuRandom::runif(n=6, streams=myStreamsGpu1, Nglobal=c(1,nrow(myStreamsGpu1)), type = "double")))
as.vector(gpuRandom::runif(n=12, streams=vclMatrix(myStreamsCpu), Nglobal=c(1,nrow(myStreamsGpu1)), type = "double"))
@
...
Nglobal = c(128,128)
streams <- CreateStreamsGpu(Nstreams =128^2, keepInitial=1)
@
