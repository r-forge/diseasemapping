...
dt <- data.frame(
  ...
  var4 = c('Intel 3.7ghz', 0.4035606,0.0001202, 14.8,  91.5),
  var5 = c('NVIDIA V100', 0.403507,0.0001274,   0.3,   1.9),
  var6 = c('Data','month','week','month','week')
)

knitr::kable(dt, col.names = NULL, caption = "Summary of comparions of Fisher's test simulation on different devices. Computer 1 is equipped with CPU Intel Xenon W-2145 3.7Ghz and AMD Radeon VII. Computer 2 is equipped with VCPU Intel Xenon Skylake 2.5Ghz and VGPU Nvidia Tesla V100 \\label{tab:summary}. Run-time varies a little bit for each execution.") %>%
