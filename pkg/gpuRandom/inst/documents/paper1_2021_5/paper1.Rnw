...
as.vector(gpuRandom::runif(n=4, streams=myStreamsGpu1, Nglobal=c(1,nrow(myStreamsGpu1)), type = "double"))
...
\end{itemize}
<<include=FALSE, tidy=TRUE>>=
sim_2 = runif(n=7,streams=myStreamsGpu2, Nglobal=c(1,nrow(myStreamsGpu1)), type="double")
as.vector(sim_2)
@
