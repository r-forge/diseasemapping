...
\begin{CodeOutput}
##       [,1]  [,2]  [,3]  [,4]
## [1,] 0.183 2.025 0.323 1.861
## [2,] 0.356 0.288 0.213 0.475
\end{CodeOutput} 
\end{CodeChunk} 
...
R> myRaster = geostatsp::squareRaster(swissBorder, 40)
R> myRaster
\end{CodeInput}
\begin{CodeOutput}
## class      : RasterLayer 
## dimensions : 26, 40, 1040  (nrow, ncol, ncell)
## resolution : 8716, 8716  (x, y)
## extent     : 2485351, 2833996, 1075013, 1301633  (xmin, xmax, ymin, ymax)
...
R> names(simRaster) = apply(expand.grid("par", 1:nrow(params),
+    "sim", 1:ncol(simMat)), 1, paste, collapse = "")
R> theSubcap = gsub("par", "parameter ", names(simRaster))
R> theSubcap = gsub("sim", ", simuation ", theSubcap)
\end{CodeInput} 
\end{CodeChunk} 
