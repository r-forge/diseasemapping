...
{\tt changed createStreams functions to be compatible with each other}

create streams on cpu
\begin{knitrout}\tiny
...
myStreamsGpu2 = createStreams(n=4, seed=12345)
...
\definecolor{shadecolor}{rgb}{1, 1, 1}\color{fgcolor}\begin{kframe}
\begin{verbatim}
sim_2 <- gpuRandom::runif(n = 6, streams = myStreamsGpu1, Nglobal = c(1,
...
\definecolor{shadecolor}{rgb}{1, 1, 1}\color{fgcolor}\begin{kframe}
\begin{verbatim}
matrix(as.matrix(myStreamsGpu1), nrow(myStreamsCpu), ncol(myStreamsCpu), dimnames = dimnames(myStreamsCpu))
##      current.g1.1 current.g1.2 current.g1.3 current.g2.1 current.g2.2
## [1,]    878672095    240667857    240667857    642281259   1069151070
## [2,]   2113333390    559530223   1309565828   1335994581     61444481
## [3,]    502033783   1322587635   1964121530   1949818481   1607232546
## [4,]    739421137   1475938232    730262207   1630192198    324551134
##      current.g2.3 initial.g1.1 initial.g1.2 initial.g1.3 initial.g2.1
## [1,]    809054265        12345        12345        12345        12345
## [2,]    197003928    336690377    597094797   1245771585     85196284
## [3,]   1462898381    502033783   1322587635   1964121530   1949818481
## [4,]    795289868    739421137   1475938232    730262207   1630192198
##      initial.g2.2 initial.g2.3
## [1,]        12345        12345
## [2,]    523477687   2094976052
## [3,]   1607232546   1462898381
## [4,]    324551134    795289868
\end{verbatim}
\end{kframe}
\end{knitrout}
...
streams_on_CPU<-gpuRandom::CreateStreamsCpu(seed = rep(12345, 6), Nstreams=4)
\end{verbatim}


{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error: 'CreateStreamsCpu' is not an exported object from 'namespace:gpuRandom'}}\begin{verbatim}
t(streams_on_CPU)
\end{verbatim}


{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in h(simpleError(msg, call)): error in evaluating the argument 'x' in selecting a method for function 't': object 'streams\_on\_CPU' not found}}\end{kframe}
\end{knitrout}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error: 'CreateStreamsGpu' is not an exported object from 'namespace:gpuRandom'}}\begin{verbatim}
streams_from_GPU <- as.matrix(streams1)
\end{verbatim}


{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in as.matrix(streams1): object 'streams1' not found}}\begin{verbatim}
streams2 = deepcopy(streams1)
\end{verbatim}


{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in h(simpleError(msg, call)): error in evaluating the argument 'object' in selecting a method for function 'deepcopy': object 'streams1' not found}}\end{kframe}
\end{knitrout}
\begin{knitrout}
\definecolor{shadecolor}{rgb}{1, 1, 1}\color{fgcolor}\begin{kframe}


{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in gpuR::colnames(streams\_from\_GPU) = c("{}current.g1.1"{}, "{}current.g1.2"{}, : object 'streams\_from\_GPU' not found}}\end{kframe}
\end{knitrout}
\begin{knitrout}
\definecolor{shadecolor}{rgb}{1, 1, 1}\color{fgcolor}\begin{kframe}
\begin{verbatim}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in h(simpleError(msg, call)): error in evaluating the argument 'x' in selecting a method for function 't': object 'streams\_from\_GPU' not found}}\end{kframe}
\end{knitrout}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in nrow(streams): object 'streams1' not found}}\begin{verbatim}
as.vector(sim_1)
\end{verbatim}


{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in as.vector(sim\_1): object 'sim\_1' not found}}\end{kframe}
\end{knitrout}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in nrow(streams): object 'streams2' not found}}\begin{verbatim}
as.vector(sim_2)
## [1] 0.7353245 0.5180770 0.6142074 0.2319392 0.1100781 0.3619766
\end{verbatim}
\end{kframe}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in as.vector(sim\_3): object 'sim\_3' not found}}\begin{verbatim}
t(as.matrix(streams1))[1:6, ]
\end{verbatim}


{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in h(simpleError(msg, call)): error in evaluating the argument 'x' in selecting a method for function 't': object 'streams1' not found}}\end{kframe}
\end{knitrout}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in CreateStreamsGpu(Nstreams = 512, keepInitial = 1): could not find function "{}CreateStreamsGpu"{}}}\begin{verbatim}
random_vector<-gpuRandom::runif(n=50000, streams=streams, 
                                Nglobal=c(64,8), type="double")
\end{verbatim}


{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in nrow(streams): object 'streams' not found}}\begin{verbatim}
random_vector<-as.vector(random_vector)
\end{verbatim}


{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in as.vector(random\_vector): object 'random\_vector' not found}}\end{kframe}
\end{knitrout}
\begin{figure}[H]
\centering
\begin{knitrout}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in hist(random\_vector, prob = TRUE, main = "{}Histogram"{}): object 'random\_vector' not found}}

{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in sort(x): object 'random\_vector' not found}}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in CreateStreamsGpu(Nstreams = 512 * 128, keepInitial = 1): could not find function "{}CreateStreamsGpu"{}}}\begin{verbatim}
normal_matrix<-gpuRandom::rnorm(c(1024,512), streams=streams, 
                                Nglobal=c(512,128), type="float")
\end{verbatim}


{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in nrow(streams): object 'streams' not found}}\end{kframe}
\end{knitrout}
\begin{knitrout}
\definecolor{shadecolor}{rgb}{1, 1, 1}\color{fgcolor}\begin{kframe}
\begin{verbatim}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in CreateStreamsGpu(Nstreams = 128\textasciicircum{}2, keepInitial = 1): could not find function "{}CreateStreamsGpu"{}}}\end{kframe}
\end{knitrout}
\begin{knitrout}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in gpuRandom::fisher.sim(month\_GPU, 1e+06, streams = streams, type = "{}double"{}, : object 'streams' not found}}\begin{verbatim}
result_monthgpu$simNum
\end{verbatim}


{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in eval(expr, envir, enclos): object 'result\_monthgpu' not found}}\begin{verbatim}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in eval(expr, envir, enclos): object 'result\_monthgpu' not found}}\end{kframe}
\end{knitrout}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in gpuRandom::fisher.sim(month\_GPU, 1e+06, streams = streams, type = "{}double"{}, : object 'streams' not found}}

{\ttfamily\noindent\itshape\color{messagecolor}{\#\# Timing stopped at: 0.001 0 0}}\end{kframe}
\end{knitrout}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in gpuRandom::fisher.sim(week\_GPU, 1e+07, streams = streams, type = "{}double"{}, : object 'streams' not found}}\begin{verbatim}
result_weekgpu$simNum
\end{verbatim}


{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in eval(expr, envir, enclos): object 'result\_weekgpu' not found}}\begin{verbatim}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in eval(expr, envir, enclos): object 'result\_weekgpu' not found}}\end{kframe}
\end{knitrout}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in gpuRandom::fisher.sim(week\_GPU, 1e+07, streams = streams, type = "{}double"{}, : object 'streams' not found}}

{\ttfamily\noindent\itshape\color{messagecolor}{\#\# Timing stopped at: 0 0 0.001}}\end{kframe}
\end{knitrout}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error: 'CreateStreamsGpu' is not an exported object from 'namespace:gpuRandom'}}\end{kframe}
\end{knitrout}
\begin{knitrout}
\definecolor{shadecolor}{rgb}{1, 1, 1}\color{fgcolor}\begin{kframe}
\begin{verbatim}
