...
diagMat = gpuBatchMatrix::cholBatch(maternCov, # D=diagMat,  # numbatchD=nrow(params),
...
\definecolor{shadecolor}{rgb}{1, 1, 1}\color{fgcolor}\begin{kframe}
\begin{figure}
\subfloat[layer.1\label{fig:maternplot-1}]{\includegraphics[width=0.45\textwidth]{figure/maternplot-1} }\subfloat[layer.2\label{fig:maternplot-2}]{\includegraphics[width=0.45\textwidth]{figure/maternplot-2} }\subfloat[layer.3\label{fig:maternplot-3}]{\includegraphics[width=0.45\textwidth]{figure/maternplot-3} }\subfloat[layer.4\label{fig:maternplot-4}]{\includegraphics[width=0.45\textwidth]{figure/maternplot-4} }\subfloat[layer.5\label{fig:maternplot-5}]{\includegraphics[width=0.45\textwidth]{figure/maternplot-5} }\subfloat[layer.6\label{fig:maternplot-6}]{\includegraphics[width=0.45\textwidth]{figure/maternplot-6} }\subfloat[layer.7\label{fig:maternplot-7}]{\includegraphics[width=0.45\textwidth]{figure/maternplot-7} }\subfloat[layer.8\label{fig:maternplot-8}]{\includegraphics[width=0.45\textwidth]{figure/maternplot-8} }\subfloat[layer.9\label{fig:maternplot-9}]{\includegraphics[width=0.45\textwidth]{figure/maternplot-9} }\subfloat[layer.10\label{fig:maternplot-10}]{\includegraphics[width=0.45\textwidth]{figure/maternplot-10} }\caption[Simulated Gaussian random fields]{Simulated Gaussian random fields}\label{fig:maternplot}
\end{figure}
\end{kframe}
\end{knitrout}
...
\definecolor{shadecolor}{rgb}{1, 1, 1}\color{fgcolor}\begin{kframe}
\begin{verbatim}
myCol = mapmisc::colourScale(simRaster, breaks=9, type='equal', dec=2)
