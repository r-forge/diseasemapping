...
+        sim_mat[i, ] <- as.vector(clrng::rnorm(n = 6, streams = streams1,
+            Nglobal = c(2, 2)))
+    } else if (i == 3) {
+        streams2 <- createStreamsGpu(4)
+        sim_mat[i, ] <- as.vector(clrng::runif(n = 6, streams = streams2,
+            Nglobal = c(2, 2)))
+    } else {
+        streams3 <- createStreamsGpu(8)
+        sim_mat[i, ] <- as.vector(clrng::rexp(n = 6, streams = streams3,
+            Nglobal = c(4, 2)))
+    }
+}
R> sim_mat
...
R> clrng::rnorm(n = 6, streams = streams_saved, Nglobal = c(2,
+    2))
\end{CodeInput} 
\end{CodeChunk} 
