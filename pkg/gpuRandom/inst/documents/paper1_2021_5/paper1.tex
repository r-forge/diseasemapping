...
## [1,]  1.25  5000      1.5      0          1         0.0000000
## [2,]  2.15  2500      2.0      0          4         0.4487990
## [3,]  0.55 15000      2.0      0          4         0.4487990
## [4,]  2.15  5000      2.0      0          4        -0.4487990
## [5,]  2.15  5000      2.0      0          2         0.7853982
...
\definecolor{shadecolor}{rgb}{1, 1, 1}\color{fgcolor}\begin{kframe}
\begin{figure}
\subfloat[par1sim1\label{fig:maternplot-1}]{\includegraphics[width=0.45\textwidth]{figure/maternplot-1} }\subfloat[par2sim1\label{fig:maternplot-2}]{\includegraphics[width=0.45\textwidth]{figure/maternplot-2} }\subfloat[par3sim1\label{fig:maternplot-3}]{\includegraphics[width=0.45\textwidth]{figure/maternplot-3} }\subfloat[par4sim1\label{fig:maternplot-4}]{\includegraphics[width=0.45\textwidth]{figure/maternplot-4} }\subfloat[par5sim1\label{fig:maternplot-5}]{\includegraphics[width=0.45\textwidth]{figure/maternplot-5} }\subfloat[par1sim2\label{fig:maternplot-6}]{\includegraphics[width=0.45\textwidth]{figure/maternplot-6} }\subfloat[par2sim2\label{fig:maternplot-7}]{\includegraphics[width=0.45\textwidth]{figure/maternplot-7} }\subfloat[par3sim2\label{fig:maternplot-8}]{\includegraphics[width=0.45\textwidth]{figure/maternplot-8} }\subfloat[par4sim2\label{fig:maternplot-9}]{\includegraphics[width=0.45\textwidth]{figure/maternplot-9} }\subfloat[par5sim2\label{fig:maternplot-10}]{\includegraphics[width=0.45\textwidth]{figure/maternplot-10} }\caption[Simulated Gaussian random fields]{Simulated Gaussian random fields}\label{fig:maternplot}
\end{figure}
\end{kframe}
\end{knitrout}
