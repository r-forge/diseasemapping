...
//    "#define NpadLocal " + std::to_string(Nlocal[1]) + "\n"    
 ...
 " int NrowStartC,\n"
  ...
  "int AHere, CHere;\n"
  "int Dmatrix, Drow, Dcol, DrowNpadC, Dinner, DinnerA, DinnerAcol, DrowBlock, DinnerBlock;\n"
...
SEXP crossprodBatchTyped(
  ...
  return Rcpp::wrap(crossprodBatch<T>(*CG, *AG, *DG, invertD, Cstartend, Astartend, Dstartend, Nglobal, Nlocal, NlocalCache, ctx_id));
