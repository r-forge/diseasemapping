...
BEGIN_RCPP
    ...
    likfitGpu_BackendP(yx, coords, params, boxcox, betas, ssqY, ssqBetahat, detVar, detReml, jacobian, NparamPerIter, workgroupSize, localSize, NlocalCache, verbose, ssqYX, XVYXVX, ssqYXcopy, LinvYX, QinvSsqYx, cholXVXdiag, varMat, cholDiagMat);
    return R_NilValue;
END_RCPP
}
// logfactsumBackend
