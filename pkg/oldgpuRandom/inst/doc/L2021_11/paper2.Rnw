...
colnames(table1) <- c('Parameter','Estimate','95% CI', 'Estimate','95% CI')
...
knitr::include_graphics(c('profile_logl_swiss.png'))
@

<<swiss_profile_sole_prep, out.width = "100%", fig.align = "center",echo=FALSE>>=
knitr::include_graphics(c('swiss_pro_4.png'))
@
