...
<<set params, echo=FALSE, cache=TRUE>>=
newParamList = list(
...
<<graphs1, echo = FALSE, eval=TRUE, cache=TRUE>>=
...
@
<<showgraphs1, echo = FALSE, eval=TRUE, cache=TRUE, fig.height =3, fig.width =4, fig.show ="hold",  fig.cap = "title", dev='png'>>=
forigin
@
