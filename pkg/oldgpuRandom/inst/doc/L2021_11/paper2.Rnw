...
<<swiss_profile_many,echo = FALSE, eval=TRUE, cache=TRUE, fig.width=4,fig.height=3, fig.show ="hold", fig.align='center', fig.cap = "profile LogL of slope parameter", out.width = "50%",dev='pdf',fig.pos="H">>=
setwd("/home/ruoyong/diseasemapping/pkg/oldgpuRandom/inst/doc/L2021_11")
knitr::include_graphics(c('profile_logl_swiss.png','betaprofile.png'))
@
